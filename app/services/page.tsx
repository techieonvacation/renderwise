...
const services = [
  {
    ...
    description: 'Professional IT recruitment and staffing solutions for businesses seeking top-tier technology talent.',
    icon: '👥',
    image: '/images/itstaff_whychs.webp',
    features: ['Custom recruitment strategies', 'Rapid placement', 'Ongoing support', 'Tech talent sourcing'],
    url: '/services/it-staffing'
  },
  {
    id: 'qa-automation',
    title: 'QA Automation Services',
    description: 'Comprehensive quality assurance and test automation services including framework development and CI/CD integration.',
    icon: '🔧',
  ...
  },
  {
    ...
    description: 'Expert Flutter development services for cross-platform mobile applications with native performance.',
    icon: '📱',
    image: '/images/home/mbl-app-dev.webp',
    features: ['Cross-platform development', 'Native performance', 'Single codebase', 'Beautiful UI/UX'],
    url: '/services/flutter'
  },
  {
    id: 'system-integration',
    title: 'System Integration',
    description: 'Enterprise system integration services including API development, data migration, and legacy modernization.',
    icon: '🔗',
    image: '/images/home/custom-dev.webp',
    features: ['API development', 'Data migration', 'Legacy modernization', 'Enterprise solutions'],
    url: '/services/system-integration'
  },
  {
    id: 'web-development',
    title: 'Web Development',
    description: 'Custom web application development with modern technologies and scalable architecture.',
    icon: '🌐',
    image: '/images/home/web-dev.webp',
    features: ['Custom web apps', 'Progressive Web Apps', 'Full-stack development', 'API development'],
  ...
  },
  {
    ...
    icon: '📲',
    image: '/images/home/mbl-app-dev.webp',
    features: ['Native iOS & Android', 'Cross-platform apps', 'App maintenance', 'UI/UX design'],
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              From IT staffing to custom development, we provide end-to-end solutions 
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service) => (
              <div key={service.id} className="bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden group">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Our experienced professionals bring deep expertise across technologies and industries.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                We use agile methodologies to deliver high-quality solutions quickly and efficiently.
              </p>
            </div>
          </div>
        </div>
