...
export const IT_STAFFING_STRUCTURED_DATA: ServiceStructuredData = {
  ...
  description:
    "Professional IT staffing and recruitment services for businesses seeking top-tier technology talent. We specialize in placing software developers, engineers, IT professionals, and tech specialists.",
...
export const QA_AUTOMATION_STRUCTURED_DATA: ServiceStructuredData = {
  ...
  description:
    "Comprehensive quality assurance and test automation services including framework development, CI/CD integration, performance testing, and automated testing solutions.",
  provider: BASE_PROVIDER,
  areaServed: "Worldwide",
...
export const FLUTTER_DEVELOPMENT_STRUCTURED_DATA: ServiceStructuredData = {
  ...
  description:
    "Expert Flutter development services for cross-platform mobile applications. We create native-performance apps for iOS and Android using a single codebase.",
  provider: BASE_PROVIDER,
  areaServed: "Worldwide",
...
export const SYSTEM_INTEGRATION_STRUCTURED_DATA: ServiceStructuredData = {
  ...
  description:
    "Enterprise system integration services including API development, data migration, legacy system modernization, and seamless technology integration solutions.",
  provider: BASE_PROVIDER,
  areaServed: "Worldwide",
...
// BFSI Service Structured Data
export const BFSI_STRUCTURED_DATA: ServiceStructuredData = {
  "@context": "https://schema.org",
  "@type": "Service",
  name: "BFSI Services",
  description:
    "BFSI services include banking, insurance, and financial services. We help businesses transform their digital presence and achieve technological excellence.",
  provider: BASE_PROVIDER,
  areaServed: "Worldwide",
...
// Life Science & Health Care Service Structured Data

export const LIFE_SCIENCE_HEALTH_CARE_STRUCTURED_DATA: ServiceStructuredData = {
  "@context": "https://schema.org",
  "@type": "Service",
  name: "Life Science & Health Care Services",
  description:
    "Life Science & Health Care Services include medical devices, pharmaceuticals, and healthcare IT solutions. We help businesses transform their digital presence and achieve technological excellence.",
  provider: BASE_PROVIDER,
  areaServed: "Worldwide",
  serviceType: "Medical Devices, Pharmaceuticals, and Healthcare IT Solutions",
  category: "Medical Devices, Pharmaceuticals, and Healthcare IT Solutions",
  offers: {
    "@type": "Offer",
    price: "Contact for pricing",
    priceCurrency: "USD",
...
export const ORGANIZATION_STRUCTURED_DATA = {
  ...
  description:
    "Eleservsoftech is a leading technology company specializing in digital solutions, IT services, and custom software development. We help businesses transform their digital presence and achieve technological excellence.",
  url: "https://eleservsoftech.vercel.app",
  logo: "https://eleservsoftech.vercel.app/images/logo.png",
  sameAs: [
...
export const FAQ_STRUCTURED_DATA = {
  ...
  mainEntity: [
    {
      "@type": "Question",
      name: "What services does Eleservsoftech offer?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Eleservsoftech offers comprehensive digital services including IT staffing, QA automation, Flutter development, system integration, web development, mobile app development, and more.",
      },
    },
    {
      "@type": "Question",
      name: "How can I get started with Eleservsoftech services?",
      acceptedAnswer: {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      name: "Does Eleservsoftech work with international clients?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Yes, Eleservsoftech serves clients worldwide. We have experience working with international businesses and can accommodate different time zones and requirements.",
      },
    },
  ],
};
