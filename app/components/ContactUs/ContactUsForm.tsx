                ...
                <div className="grid lg:grid-cols-2 gap-8">
                    ...
                    >
                        <div className="space-y-4">
                            ...
                            <p
                                className="text-muted-foreground max-w-lg font-inter"
                            >
                        ...
                        <div className="grid gap-6">
                            ...
                            <div className="bg-card p-6 rounded-xl border border-border/50 hover:border-primary/50 transition-colors">
                                <div className='flex items-center gap-x-6'>
                                    <div className="relative flex items-center justify-center w-12 h-12 lg:w-16 lg:h-16">
                                    ...
                                    <div className='flex flex-col'>
                                        ...
                                        <Link href="tel:+918851967714" className='text-muted-foreground font-inter'>
                                            +91 8851967714
                                        </Link>
                                        <Link href="tel:+918851967714" className='text-muted-foreground font-inter'>
                                            +91 8851967714
                            ...
                            <div className="bg-card p-6 rounded-xl border border-border/50 hover:border-primary/50 transition-colors">
                                <div className='flex items-center gap-x-6'>
                                    ...
                                    <div className='flex flex-col'>
                                        ...
                                        <Link href="mailto:hackintowntech@gmail.com" className='text-sm lg:text-base text-muted-foreground font-inter'>
                                ...
                                <div className='flex items-center gap-x-6'>
                                    ...
                                    <div className='flex flex-col'>
                                        ...
                                        <p className="text-muted-foreground font-inter text-sm lg:text-base">
                                            C-113 , 4rth floor , Sector 2,<br className='block lg:hidden' />
                                            Noida Near by SBI Bank, 201301,<br />
                                            Uttar Pradesh, India
                                        </p>
                                    </div>
                                </div>
                    ...
                    {/* Contact Form */}
                    <div
                        className="relative bg-card p-6 rounded-xl border border-border transition-colors"
                    >
                        <AnimatePresence>
                            {isSuccess && (
                                <motion.div
                                ...
                                >
                                    <div className="text-center">
                                        ...
                                        <p className="text-gray-600 dark:text-gray-400 mt-2">We will respond within 24 hours.</p>
                                    </div>
                                </motion.div>
                            )}
                        </AnimatePresence>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            <div className="grid sm:grid-cols-2 gap-4 sm:gap-6">
                                {[
                                    { label: 'Name', type: 'text', placeholder: 'John Doe', key: 'name', required: true },
                                    { label: 'Email', type: 'email', placeholder: 'john@doe.com', key: 'email', required: true }
                                ].map((field) => (
                                    <motion.div
                                        key={field.key}
                                        className="space-y-2"
                            ...
                            <div className="space-y-2">
                                <label className="text-sm font-medium font-space-grotesk text-foreground">Phone</label>
                                <input
                                    type="tel"
